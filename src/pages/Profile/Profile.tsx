                ...
                <div className="col-md-5 border-right">
                    <div className="p-3 py-5">
                        ...
                        <div className='button-array'>
                            <div className="mt-4 text-center"><button onClick={updateProfile} className="btn btn-primary profile-button" type="button">Save Profile</button></div>
                            <div className="mt-4 text-center"><button onClick={logout} className="btn btn-danger profile-button" type="button">Logout</button></div>
                        </div>
                    </div>
                </div>
